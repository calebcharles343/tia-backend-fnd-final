...
export default function Sidebar() {
  ...
  return (
    <nav
      className="flex flex-col bg-gray-800 text-gray-50 items-center row-start-1 row-end-3 w-full h-full px-4 pt-4 pb-24 shadow-xl gap-4 bg-cover bg-center bg-no-repeat"
    ...
    >
      ...
      <ul className="flex flex-col gap-1 text-md w-full p-8">
        <li>
          <Link
            to="Home"
      ...
      {isPending ? (
        ...
        <button
          className="flex items-center gap-2 mt-auto text-gray-800 bg-gray-50 p-2 rounded hover:bg-[#ffa82b] hover:text-gray-800 transition-colors duration-200"
